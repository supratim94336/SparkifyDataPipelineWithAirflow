# Instructions
# Use the Airflow context in the pythonoperator to complete the TODOs
# below. Once you are done, run your DAG and check the logs to see the
# context in use.
...
def log_details(*args, **kwargs):
    #
    # TODO: Extract ds, run_id, prev_ds, and next_ds from the kwargs,
    #  and log them
