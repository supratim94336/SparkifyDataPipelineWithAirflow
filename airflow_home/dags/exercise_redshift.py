# Instructions
# Similar to what you saw in the demo, copy and populate the trips
# table. Then, add another operator which creates a traffic analysis
# table from the trips table you created. Note, in this class, we won’t
